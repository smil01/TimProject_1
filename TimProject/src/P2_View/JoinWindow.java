...
public class JoinWindow extends JPanel {
	...
	public JoinWindow() {
		...
		lbl_img.setIcon(new ImageIcon(JoinWindow.class.getResource("/P5_Img/uefa.jpg")));
		...
		btn_sign_in.setFont(new Font("���� ���", Font.BOLD, 15));
		...
		lbl_sign_up_intro.setFont(new Font("���� ���", Font.PLAIN, 12));
