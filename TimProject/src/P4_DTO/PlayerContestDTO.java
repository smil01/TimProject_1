...
public class PlayerContestDTO {
	...
	public String toString() {
		return "PlayerContestDTO [Player_Code=" + Player_Code + ", Group_Code=" + Group_Code + ", Player_Contest_Code="
				+ Player_Contest_Code + ", Player_Contest_Title=" + Player_Contest_Title + ", Player_Contest_Content="
				+ Player_Contest_Content + ", Player_Contest_Result=" + Player_Contest_Result + ", Player_Contest_Shot="
				+ Player_Contest_Shot + ", Player_Contest_EffectiveShot=" + Player_Contest_EffectiveShot
				+ ", Player_Contest_Goal=" + Player_Contest_Goal + ", Player_Contest_Assist=" + Player_Contest_Assist
	...
	public PlayerContestDTO(int player_Code, int group_Code, int player_Contest_Code, String player_Contest_Title,
